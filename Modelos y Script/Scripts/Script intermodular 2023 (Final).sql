...
/* Created on:     15/05/2023 12:37:03                          */
/*==============================================================*/
...
insert into EVENTO (ID_EVENTO,ID_MENU,NOMBRE_EVENTO,FECHA_EVENTO,NUMERO_SALA,ES_CUMPLE)
            values (1,null,'Cumpleaños Juan','15/FEB/2022',1,1);
insert into EVENTO (ID_EVENTO,ID_MENU,NOMBRE_EVENTO,FECHA_EVENTO,NUMERO_SALA,ES_CUMPLE)
...
insert into EVENTO (ID_EVENTO,ID_MENU,NOMBRE_EVENTO,FECHA_EVENTO,NUMERO_SALA,ES_CUMPLE)
            values (5,null,'Cumpleaños Ana','12/MAR/2022',3,1);
insert into EVENTO (ID_EVENTO,ID_MENU,NOMBRE_EVENTO,FECHA_EVENTO,NUMERO_SALA,ES_CUMPLE)
            values (6,null,'Cumpleaños Lucía','23/APR/2022',1,1);
insert into EVENTO (ID_EVENTO,ID_MENU,NOMBRE_EVENTO,FECHA_EVENTO,NUMERO_SALA,ES_CUMPLE)
...
-- /*==============================================================*/
-- create index CORRESPONDE2_FK on EVENTO (
